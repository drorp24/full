...
const useGlobalState = () => {
  ...
  const updateGlobalState = (values, touched, errors) => {
    ...
    const oldStateClone = Object.assign({}, globalState)
    ...
    console.log(
      'globalState.values.currency at the end of updateGlobalState: ',
...
const ProductForm = () => {
  const form = ({
    ...
    console.log(
      'Rendering ProductForm. values.currency: ',
      values.currency,
      ' errors.currency: ',
      errors.currency,
      'state:',
  ...
  return (
    <Formik
      ...
      render={props => form({ ...props, state, updateState })}
    />
  )
}
